...
import (
	entity "github.com/jailtonjunior94/financial/internal/category/domain/entity"
...
func (_m *CategoryRepository) Find(userID string) ([]*entity.Category, error) {
...
// FindByID provides a mock function with given fields: userID, id
func (_m *CategoryRepository) FindByID(userID string, id string) (*entity.Category, error) {
	...
	var r0 *entity.Category
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (*entity.Category, error)); ok {
		return rf(userID, id)
	}
	if rf, ok := ret.Get(0).(func(string, string) *entity.Category); ok {
		r0 = rf(userID, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.Category)
