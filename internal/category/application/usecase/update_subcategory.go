...
func NewUpdateSubcategoryUseCase(
o11y observability.Observability,
fm *metrics.FinancialMetrics,
categoryRepo interfaces.CategoryRepository,
subcategoryRepo interfaces.SubcategoryRepository,
...
func (u *updateSubcategoryUseCase) Execute(ctx context.Context, userID, categoryID, id string, input *dtos.SubcategoryInput) (*dtos.SubcategoryOutput, error) {
ctx, span := u.o11y.Tracer().Start(ctx, "update_subcategory_usecase.execute")
defer span.End()
...
if err := subcategory.Update(input.Name, input.Sequence); err != nil {
return nil, err
}

if err := u.subcategoryRepo.Update(ctx, subcategory); err != nil {
return nil, err
}
